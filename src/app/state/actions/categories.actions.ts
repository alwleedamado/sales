...
export const LoadCategoriesSuccess = createAction('[Categories] load categories list successes', props<{list: Category[]}>());

export const AddCategory = createAction('[Categories] Add Category', props<{entity: Category}>());
